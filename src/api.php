...
class API extends http{
    ...
    public function kickChatMember($id, $uId, $until = 0, $deleteAllMessages = false)
    {
        $data["chat_id"] = $id;
        $data["user_id"] = $uId;
    ...
    {
        $data["chat_id"] = $id;
        return $this->ApiRequest("getChatMembersCount", $data);
    }
    ...
    public function text_adjust($text)
    {
        ...
        if (strlen($text) > 4048)
            $text = "message is too long. 1 " . $this->Request("https://nbots.ga/deldog/index.php", ["data" => $text], false) . " 2";
        elseif ($text == '')
            $text = "";
